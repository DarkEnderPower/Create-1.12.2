...
import darkenderhilda.create.test.TestBlockTESR;
import darkenderhilda.create.test.TestBlockTileEntity;
...
public class AllTileEntity {
    ...
    static {
        ...
        REGISTER.tileEntity(TestBlockTileEntity.class, "testBlockTileEntity")
                .validBlocks(AllBlocks.TEST)
                .visual(new TestBlockTESR())
                .register();
    }
